    ...
    <div>
      <div className="add-movie">
        ...
        <Button onClick={() => {
          ...
          className='toggle-btn' variant="outlined" color="primary">Add Movie</Button>
      </div>
  ...
  return (
    <div className="movie-container">
      ...
      <div className="movie-detail">
        ...
        <Button className='toggle-btn' variant="outlined" color="primary" onClick={() => { setToggle(!toggle) }}>Toggle</Button>
